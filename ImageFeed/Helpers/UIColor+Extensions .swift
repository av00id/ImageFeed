...
//  ImageFeed
//
//  Created by Сергей Андреев on 09.12.2022.
//
...
extension UIColor {
    ...
    static var ypBlackground: UIColor { UIColor(named: "YP Blackground")!}
    ...
    static var ypWhite_Alpha50: UIColor { UIColor(named: "YP White_Alpha50")!}
