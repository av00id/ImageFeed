//
//  AnimationGradientFactory.swift
//  ImageFeed
//
//  Created by Сергей Андреев on 06.02.2023.
//
...
class AnimationGradientFactory {
    ...
    func createGradient(width: CGFloat, height: CGFloat, offsetX: CGFloat = 0, offsetY: CGFloat = 0, cornerRadius: CGFloat) -> CAGradientLayer {
        ...
        gradient.startPoint = CGPoint(x: 0, y: 5)
        ...
        gradient.add(gradientChangeAnimation, forKey: "locationChange")
